...
badd +1 test\FlxBasic.as
badd +1 test\expected\FlxBasic.js
badd +1 ~\vimfiles\ftplugin\python.vim
...
exe 'vert 2resize ' . ((&columns * 62 + 66) / 133)
exe '3resize ' . ((&lines * 1 + 16) / 33)
exe 'vert 3resize ' . ((&columns * 70 + 66) / 133)
exe '4resize ' . ((&lines * 1 + 16) / 33)
exe 'vert 4resize ' . ((&columns * 70 + 66) / 133)
exe '5resize ' . ((&lines * 27 + 16) / 33)
exe 'vert 5resize ' . ((&columns * 70 + 66) / 133)
argglobal
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let s:l = 59 - ((12 * winheight(0) + 14) / 29)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 114 - ((24 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
114
